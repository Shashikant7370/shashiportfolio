...
function Hero({show}) {
  ...
  return (
    <section
      id="hero"
      className="bg-[rgb(11,26,51)] w-full flex flex-col-reverse lg:flex-row  justify-center items-center sm:justify-evenly px-10 sm:px-20 sm:py-32 relative"
    >
      <div
        data-aos="fade-up-right"
        className=" flex max-w-[500px] flex-col p-3 text-white"
      >
      ...
      <div data-aos="fade-up-left" className="z-30">
        <img
      ...
      <img
        src="/linejhalar.png"
        className="h-[500px] w-full absolute bottom-0 left-0 opacity-15"
      />
    </section>
  );
}
